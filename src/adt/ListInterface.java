...
public interface ListInterface<T> {
     ...
     * is full, newPosition getLength()+1
     */
    ...
    /**
     * Task : Check the first position of an entry, only show the first position
     * if got multiple
     *
     * @param anEntry the object that is desired to be found
     * @return the integer of position if the object is found and 0 if not found
     */
